...
export default function PrivacyPage() {
  return (
    <>
      <Header />
      <main className="pt-20 min-h-screen bg-[#07131C]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-invert max-w-none text-gray-300 space-y-6">
            <p>
              ...
              <Link href="https://genkoustudio.ru" className="text-[#D7FB72] hover:underline">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">2. Обработка персональных данных</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Согласие на обработку</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Контакты</h2>
            <p>
          ...
          <div className="mt-12">
            <Link
              href="/"
              className="text-[#D7FB72] hover:underline inline-flex items-center gap-2"
            >
