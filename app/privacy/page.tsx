...
export default function PrivacyPage() {
  return (
    <>
      <NavBar />
      <main className="pt-20 min-h-screen bg-[#F8F9FB]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="font-heading font-bold text-4xl mb-8 text-[#1B1B1B]">Политика конфиденциальности</h1>
          <div className="prose max-w-none text-[#6E7580] space-y-6">
            <p>
              ...
              <Link href="https://genkoustudio.ru" className="text-[#C7FF6E] hover:underline hover-neon transition-all">
                https://genkoustudio.ru
              </Link>
              .
            </p>
            <h2 className="font-heading font-bold text-2xl text-[#1B1B1B] mt-8 mb-4">1. Общие положения</h2>
            <p>
            ...
            <h2 className="font-heading font-bold text-2xl text-[#1B1B1B] mt-8 mb-4">2. Обработка персональных данных</h2>
            <p>
            ...
            <h2 className="font-heading font-bold text-2xl text-[#1B1B1B] mt-8 mb-4">3. Согласие на обработку</h2>
            <p>
            ...
            <h2 className="font-heading font-bold text-2xl text-[#1B1B1B] mt-8 mb-4">4. Контакты</h2>
            <p>
          ...
          <div className="mt-12">
            <Link
              href="/"
              className="text-[#C7FF6E] hover:underline hover-neon transition-all inline-flex items-center gap-2 font-medium"
            >
